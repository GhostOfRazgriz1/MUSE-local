"""The Persistent Agent — the kernel of Agent OS.
...
from agent_os.debug import get_tracer

import aiosqlite

from agent_os.config import Config
from agent_os.db.session_repository import SessionRepository
from agent_os.kernel.context_assembly import ContextAssembler, AssembledContext, load_identity
from agent_os.kernel.identity_editor import (
...
from agent_os.kernel.intent_classifier import SemanticIntentClassifier, ExecutionMode, SubTask
from agent_os.kernel.dreaming import DreamingManager
from agent_os.kernel.onboarding import OnboardingFlow
from agent_os.kernel.patterns import PatternTracker
from agent_os.kernel.scheduler import Scheduler
from agent_os.kernel.task_manager import TaskManager, TaskInfo
...
class Orchestrator:
    """The persistent agent loop — heart of Agent OS.
    ...
    def __init__(
        ...
        from agent_os.kernel.hooks import HookRegistry
        self._hooks = HookRegistry()

        # Proactive behavior manager
        from agent_os.kernel.proactivity import ProactivityManager
    ...
    async def _try_resume_plan(self) -> AsyncIterator[dict]:
        ...
        from agent_os.kernel.intent_classifier import ClassifiedIntent, ExecutionMode
    ...
    async def _execute_sub_task(
        ...
        # ── Before-hook ────────────────────────────────────────
        from agent_os.kernel.hooks import HookContext
