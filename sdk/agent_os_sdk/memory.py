"""agent_os.memory — Read and write to the skill's memory namespace."""
...
class MemoryClient:
    ...
    async def search(self, query: str, limit: int = 10) -> list[MemoryEntry]:
        ...
        from agent_os_sdk.ipc_client import MemorySearchMsg
    ...
    async def list_keys(self, prefix: str = "") -> list[str]:
        ...
        request_id = str(uuid.uuid4())
        from agent_os_sdk.ipc_client import MemoryListKeysMsg
    ...
    async def _memory_read(self, namespace: str, key: str) -> Optional[str]:
        ...
        from agent_os_sdk.ipc_client import MemoryReadMsg
    ...
    async def _memory_write(self, namespace: str, key: str, value: str, value_type: str) -> None:
        request_id = str(uuid.uuid4())
        from agent_os_sdk.ipc_client import MemoryWriteMsg
