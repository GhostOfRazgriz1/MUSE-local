...
from agent_os_sdk.memory import MemoryClient
from agent_os_sdk.http import HttpClient
from agent_os_sdk.user import UserClient
from agent_os_sdk.task import TaskClient
from agent_os_sdk.llm import LLMClient
from agent_os_sdk.files import FilesClient
from agent_os_sdk.skill import SkillClient
...
class SkillContext:
    ...
    def require_permission(self, permission: str) -> None:
        if permission not in self.permissions:
            from agent_os_sdk.errors import PermissionDenied
