"""agent_os.task — Request sub-task spawning through the orchestrator."""
...
class TaskClient:
    ...
    async def request_spawn(
        ...
        from agent_os_sdk.ipc_client import SpawnRequestMsg
    ...
    async def report_checkpoint(self, description: str, result: Any = None) -> None:
        ...
        from agent_os_sdk.ipc_client import StatusMsg
