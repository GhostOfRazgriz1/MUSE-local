"""agent_os.user — Interact with the user through the orchestrator."""
...
class UserClient:
    ...
    async def ask(self, question: str, options: list[str] | None = None) -> str:
        ...
        """
        from agent_os_sdk.ipc_client import UserAskMsg
    ...
    async def notify(self, message: str) -> None:
        ...
        from agent_os_sdk.ipc_client import UserNotifyMsg
    ...
    async def confirm(self, action_description: str) -> bool:
        ...
        """
        from agent_os_sdk.ipc_client import UserConfirmMsg
        ...
        if resp.response is False:
            from agent_os_sdk.errors import UserCancelled
