"""agent_os.llm — Make LLM calls through the orchestrator's model routing layer."""
...
class LLMClient:
    ...
    async def complete(
        ...
        from agent_os_sdk.ipc_client import LLMRequestMsg
        ...
        if hasattr(resp, "error") and resp.error:
            from agent_os_sdk.errors import ExternalServiceError
